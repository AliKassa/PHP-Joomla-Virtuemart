<?php 
	...
	foreach ($payment_systems as $ps => $info ) { ?>
						...
						<div class="col-sm-3 text-center payment_system" data-title="<?php echo $ps; ?>">
							<div class="panel panel-warning panel-pricing">
								<div class="panel-heading">
									<img src="<?php echo $img_path; ?><?php echo $ps; ?>.png" alt="<?php echo $info['title'] ; ?>">
									<h3>Оплатить с помощью <?php echo $info['title'] ; ?></h3>
								</div>
				...
				<script type="text/javascript">
					...
					(function($) {
						...
						$(document).ready(function () {
							...
							var form = $('form[name="vm_alikassa_form"]');

							$('.col-sm-3.text-center.payment_system').click(function () {


								var ak_pw_via = $(this).attr('data-title');

								if($('input[name =  "payWayVia"]').length > 0){
									$('input[name =  "payWayVia"]').val(ak_pw_via);
								}else{
									form.append(
										$('<input>', {
											type: 'hidden',
